		...
		<>
			<motion.div variants={textVariant()}>
				...
				>
					...
					data-driven products. My work spans product thinking, data analysis, machine learning and software development.<br></br>
					I specialize in combining technical depth with product and business sense, backed by strong skills in Python, C++, Java, SQL, and modern ML frameworks. <br></br>
					I actively engage in platforms like Kaggle and Google Cloud to sharpen my skills and bring data-informed decision making into everything I build.
				</motion.p>
